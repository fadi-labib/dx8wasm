...
- Remaining fixed-function niceties (as a target needs them): EXP/EXP2 fog, vertex-blend, per-stage alpha op, more texture formats. Cross-check against DXVK/Wine but **never paste** (LGPL).
