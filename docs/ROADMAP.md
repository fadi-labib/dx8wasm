...
- ⏳ **2.6 next:** common render-state subset — depth test/write, alpha blend, backface cull, in-shader alpha test (the subset Generals' menu/skirmish hits); mixed opaque + alpha scene readback.
